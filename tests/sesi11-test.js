...
describe('Saucedemo Test', () => {
    ...
    beforeEach(async () => {
        ...
        // assertions
        try {
            let item = await driver.findElement(pageInventory.item);
    ...
    it('Sort Items A-Z in Saucedemo Inventory Page', async () => {
        // select dropdown
        let sort = await driver.findElement(pageInventory.sort);
        await sort.click();
        let selection = await driver.findElement(pageInventory.sortSelection);
        await selection.click();

        // assertions - get items list
        let sortedItems = await driver.findElements(pageInventory.items);
